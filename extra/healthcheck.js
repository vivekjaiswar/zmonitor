...
const sslKey = process.env.ZMONITOR_SSL_KEY || process.env.SSL_KEY || undefined;
const sslCert = process.env.ZMONITOR_SSL_CERT || process.env.SSL_CERT || undefined;
...
let hostname = process.env.ZMONITOR_HOST;
...
const port = parseInt(process.env.ZMONITOR_PORT || process.env.PORT || 3001);
